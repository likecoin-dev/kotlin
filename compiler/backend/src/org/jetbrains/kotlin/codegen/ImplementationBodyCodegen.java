...
public class ImplementationBodyCodegen extends ClassBodyCodegen {
    ...
    private void generateFieldForSingleton() {
        ...
        v.newField(OtherOrigin(classObject), ACC_PUBLIC | ACC_STATIC | ACC_FINAL, deprecatedField.name, deprecatedField.type.getDescriptor(), null, null);
    ...
    private void generateClassObjectInitializer(@NotNull ClassDescriptor classObject) {
        ...
        codegen.v.dup();
        StackValue.singleton(classObject, typeMapper).
                store(StackValue.onStack(typeMapper.mapClass(classObject)), codegen.v, true);
        StackValue.deprecatedClassObjectAccessor(classObject, typeMapper).
                store(StackValue.onStack(typeMapper.mapClass(classObject)), codegen.v, true);
    }
