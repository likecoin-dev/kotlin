...
public class InjectorForTopDownAnalyzerForJs {
    ...
    public InjectorForTopDownAnalyzerForJs(
        ...
        this.typeResolver = new TypeResolver(annotationResolver, qualifiedExpressionResolver, module, flexibleTypeCapabilitiesProvider, storageManager, typeLazinessToken, dynamicTypesAllowed);
